...
export function GuardrailsParameters({ onCategoryChange }: { onCategoryChange?: () => void }) {
  const { data: categories, error, isLoading, mutate } = useParameterCategories({ type: "guardrail" })
